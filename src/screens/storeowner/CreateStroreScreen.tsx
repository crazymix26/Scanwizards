...
export default function AddStoreScreen() {
    ...
    const checkLocationPermission = async () => {
        ...
        if (status !== 'granted') {
            Alert.alert(
                ...
                'Please enable location services to set your store location',
                [
                    {
                        text: 'Cancel',
                        style: 'cancel'
    ...
    const handleMapPress = (e: { nativeEvent: { coordinate: { latitude: any; longitude: any; }; }; }) => {
        ...
        setLocationAccuracy(null); // Manual selection has unknown accuracy
    };
    ...
    const handleCreateStore = async () => {
        ...
        try {
            ...
            Alert.alert(
                'Success',
                'Your store has been submitted for admin approval',
                [
                    {
                        text: 'OK',
                        onPress: () => {
